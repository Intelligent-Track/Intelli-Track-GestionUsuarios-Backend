...
public class AuthServiceImpl implements AuthService {
  ...
  public String addUser(SignupRequest userRequest) {
    ...
    if (strRoles == null) {
      ...
      /*
       * Cliente cliente = new
       * Cliente(userRequest.getUsername(),userRequest.getName());
      ...
      strRoles.forEach(role -> {
        switch (role) {
          ...
          case "GGEN":
            ...
            /*
             * Gerente Gerente = new
             * Gerente(userRequest.getUsername(),userRequest.getName());
          ...
          case "GREG":
            ...
            roles.add(GREG);
            /*
             * Gerente = new Gerente(userRequest.getUsername(),userRequest.getName());
             * //agregar el distintivo de que es regional
             * GerenteRepository.save(Gerente);
             */
            // llamada del servicio de correo
            break;
          ...
          case "CON":
             ...
             * Conductor(userRequest.getUsername(),userRequest.getName());
          ...
          case "CONV":
             ...
             * ConductorRepository.save(Conductor); //agregar el distintivo de que es
             * invitado
             */
            // llamada del servicio de correo
            break;
          ...
          case "MEC":
             ...
             * Mecanico(userRequest.getUsername(),userRequest.getName());
           ...
           * Operador(userRequest.getUsername(),userRequest.getName());
    ...
    /////////////////////////////////////////////// Salvar user and mandar
    /////////////////////////////////////////////// correo//////////////////////////////////////////////////////////////
    userRepository.save(user);

    return "Bienvenido, " + userRequest.getName() + ", fuiste registrado exisitosamente con el correo "
        + userRequest.getUsername() + " lo cual usuaras para tu loggin!";
